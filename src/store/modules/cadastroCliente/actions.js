...
//CLIENTE COMPLETO
export function getClienteCompleto(action) {
  return {
    type: "@cadastroCliente/GET_CLIENTE_COMPLETO",
    payload: action
  };
}

//ENDERECO COMPLEMENTO
export function setEnderecoComplemento(action) {
  return {
    type: "@cadastroCliente/SET_ENDERECO_COMPLEMENTO",
    payload: action
  };
}
